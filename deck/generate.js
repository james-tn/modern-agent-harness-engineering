...
const sources = {
  L: `Public presentation plan: 13 slides; 30 minutes prepared content, including a five-minute walkthrough, plus a proposed 15-minute discussion slot. Exact minute marks, speaker ownership and the synthetic equity fixture are presentation choices. Adjust discussion to the usable session time. Editable presentation definition: ${repo}/blob/main/deck/generate.js`,
